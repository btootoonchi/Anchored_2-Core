...
public class SeparateChainingHash<Key, Value> {
     ...
     */
    public boolean contains(int i, Key key) {
        return get(i, key) != null;
    } 
...
//        int i = hash(key);
    ...
    public static void main(String[] args) {
    	SeparateChainingHash<Integer, Integer> sth = new SeparateChainingHash<Integer, Integer>(100);
    	for (int i = 0; i < 10; ++i) {
    		sth.st[i].put(2, 2);
    		sth.st[i].put(2, 5);
    		sth.st[i].put(3 + i, 2 * 2);
    		sth.st[i].put(12 + i, 2 * 2);
    		sth.st[i].put(20 + i, 2 * 2);
    	}
    	for (int i = 0; i < 5; ++i) {
